...
prompt_spicy = ChatPromptTemplate.from_messages(
    [
        ("system", """
                    ...
                    독한말의 정도 기준은
                    1 - 10 상대방에게 큰 영향을 주지 않는 가벼운 농담
                    예: "넌 정말 독특한 스타일이야!"
                    11 - 20 약간의 부정적인 의미가 있지만 상대방이 웃어넘길 수 있는 정도
                    예: "넌 매번 길을 잘못 찾아."
                    21 - 30 다소 비꼬는 말투지만 큰 상처를 주지 않는 정도
                    예: "네가 요리한 건 정말 독창적이야."
                    31 - 40 상대방을 살짝 무시하는 말투, 하지만 크게 심각하지 않음
                    예: "너는 정말 대단한 자존심을 가졌구나."
                    41 - 50 상대방에게 불쾌감을 줄 수 있는 비판 
                    예: "넌 항상 제 시간에 도착하는 법이 없지"
                    51 - 60 상대방을 직접적으로 비난하는 말
                    예: "너는 정말로 일을 대충대충 하는구나."
                    61 - 70 상대방의 성격이나 능력을 비난하는 상처를 줄 수 있음
                    예: "너는 정말로 게으르고 무책임해."
                    71 - 80 상대방을 심하게 비꼬거나 조롱하는 말
                    예: "네가 뭘 할 수 있을 거라고 생각한 적이 있긴 해?"
                    81 - 90 상대방을 모욕하거나 크게 상처를 줄 수 있는 말
                    예: "넌 정말 쓸모없는 존재야."
                    91 - 100 상대방에게 큰 정신적 충격을 줄 수 있는 매우 독한 말
