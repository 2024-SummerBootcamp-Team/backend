...
@router.get("/users/", response_model=list[usersSchema.User])
...
@router.post("/users/", response_model=usersSchema.User)
...
@router.get("/users/{user_id}", response_model=usersSchema.User)
