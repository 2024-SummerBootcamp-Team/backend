...
# 저장된 모든 발췌 이미지 목록 조회
@router.get("", response_model=ResultResponseModel, summary="저장된 모든 발췌 이미지 목록 조회", description="DB에 저장된 모든 발췌 이미지 목록을 조회합니다.")
...
@router.get("/chat/{chat_id}", response_model=ResultResponseModel, summary="채팅방 별 발췌 이미지 목록 조회", description="특정 채팅방에서 저장된 발췌 이미지 목록을 조회합니다.")
...
# 저장한 발췌 이미지 상세 조회
@router.get("/{image_id}", response_model=ResultResponseModel, summary="발췌 이미지 상세 조회", description="특정 발췌 이미지의 상세 정보를 조회합니다.")
...
# 저장한 발췌 이미지 소프트 삭제
@router.put("/{image_id}", response_model=ResultResponseModel, summary="발췌 이미지 소프트 삭제", description="특정 발췌 이미지를 삭제 처리합니다.")
...
# 저장한 발췌 이미지 하드 삭제
@router.delete("/{image_id}", response_model=ResultResponseModel, summary="발췌 이미지 하드 삭제", description="특정 발췌 이미지를 DB에서 삭제합니다.")
